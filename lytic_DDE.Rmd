...
derivs<-function(x,y){
  ...
  surv = exp(-c * T)
	...
	yx[2]=beta*y[1]*y[3] - c*y[2] - beta*S_T*V_T*surv
	yx[3]=gamma*beta*S_T*V_T*surv - muv*y[3]
	yx
...
plot(seq(0, max(t1), length = 10),
     ...
     main = expression("Lytic phage DDE dynamics (T = 1/" * alpha * " = 31.65 min)"),
     type = "n", log = "y")
